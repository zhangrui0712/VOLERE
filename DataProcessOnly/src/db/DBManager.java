...
public class DBManager {
    ...
    //鐢ㄦ埛娉ㄥ唽瀛樺偍澹扮汗淇℃伅
    public static boolean saveUserVoice(String uaId, float[] voiceDataF) {

        String sql = "insert into user_profile(user_id,codedata) values (?,?)";
        ...
        try {
            ...
            //    String challengeCode = responseCmd.challengeCodes.get(i);
                String data = voiceToString(voiceDataF);
    ...
    /**
    //鏇存柊澹扮汗淇℃伅
    public static boolean uodateUserVoice(String uaId, Float voiceDataF) {
        String sql = "update user_profile set codedata = ? where user_id = ?";
        Connection conn = getConnection();
        PreparedStatement pst = null;
        try {
            pst = conn.prepareStatement(sql);
    ...
    **/
    ...
    /**
    public static double[][] getUserVoiceData(String user_id) throws SQLException {
