...
public class PreProcess {
    ...
    private float[] afterEndPtDetection;// after endPointDetection
    public int noOfFrames;// calculated total no of frames 
    private int samplePerFrame;// how many samples in one frame 256/512
    private int framedArrayLength;// how many samples in framed array
