package idpservice.audio.feature;
...
//			System.out.println(featureVector[i][3 * numCepstra]);
//			System.out.println(featureVector[i][3 * numCepstra+ 1]);
//			System.out.println(featureVector[i][3 * numCepstra+ 2]);
		}
		System.out.println("-----获取特征信号成功！-----");
